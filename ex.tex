...
\onslide<1-> { \THit{z_0}{}{a_0}{.west}{a_1} }
...
%****************************
%%% Non-frappes pour l'exemple des points fixes 2
\def \exdefpoint {
\path[use as bounding box] (0,-1) rectangle (4,4);
\node[process,draw=red,thick] (a_1) at (a_1.center) {};

\path<1-> (z_0) edge (b_0) (b_0) edge (a_0);
%\path<> (z_2) edge (b_0) edge (a_0);
\path<1-> (z_2) edge (b_1);
\path<1-> (z_1) edge (b_1) edge (a_0);
%\path<-3> (z_0) edge (a_0);

%\path<7> (z_0) edge (b_0) (b_0) edge (a_0);
%\path<7> (z_2) edge (b_0) edge (a_0);
%\path<7> (z_2) edge (b_1);
%\path<7> (z_1) edge (b_1) edge (a_0);

\path<1->[very thick] (z_2) edge (b_0) edge (a_0) (b_0) edge (a_0);
%\path<5>[very thick] (z_2) edge (b_0) edge (a_0) (b_0) edge (a_0);
%%%\path<3>[very thick] (a_0) edge (b_0);
%%%\path<3>[very thick] (z_0) edge (b_0);
%\path<4>[dashed, very thick] (z_0) edge (a_0);
%\path<5->[very thick] (z_0) edge (a_0);

\TState{1-}{z_2,b_0,a_0}
%\TState{5}{z_2,b_0,a_0}
...
\path<2-4> (z_0) edge (b_0) (b_0) edge (a_0);
\path<2-4> (z_2) edge (b_0) edge (a_0);
\path<2-4> (z_2) edge (b_1);
\path<2-4> (z_1) edge (b_1) edge (a_0);
%\path<-3> (z_0) edge (a_0);
